...
const DocsPage = () => {
  ...
  const senhasDocs = senhasAguardando.filter((senha) => senha.etapa === "docs");
  ...
  return (
    <div className="flex h-screen">
      <SidePostos
        pessoasEsperando={senhasDocs.length}
        proximasSenhas={senhasDocs}
      ...
      <div className="flex flex-col flex-1 h-screen overflow-hidden">
        ...
        <main className="flex-1 bg-gray-100 p-4 overflow-auto flex items-center justify-center flex-col">
          <DocsPanel finalizarSenha={finalizarSenha} />
        </main>
      </div>
    </div>
  );
